...
var accountSummaries = require('/js/javascript-api-utils/lib/account-summaries');

/*var accountSummaries = '/js/javascript-api-utils/lib/account-summaries';
require([accountSummaries], function(fooModule){
