...
if($siteID != ''){
	$uploadsQuery = "SELECT * FROM siteTable WHERE id = '$siteID'";
	$uploadsResult = mysql_query($uploadsQuery);
	while($uploadsRecord = mysql_fetch_assoc($uploadsResult)){
		//$folderPath = $prefix.$uploadsRecord['root'].'images/uploads/';
		$folderPath = '../../../../images/uploads';
		$siteRoot = $uploadsRecord['url'].'/images/uploads/';
		$_SESSION['siteRoot'] = $siteRoot;
	}
}
