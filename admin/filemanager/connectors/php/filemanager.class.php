...
class Filemanager {
        ...
        public function setFileRoot($path) {
                ...
                if($this->config['options']['serverRoot'] === true) {
						...
						$this->dynamic_fileroot =  $_SESSION['siteRoot'];
                }
        ...
        public function getinfo() {
                ...
                if($this->dynamic_fileroot != '') {
						...
						$realRoot = $_SESSION['siteRoot'];
						$tempPath = explode("http:/",$path);
						$path = 'http://'.$tempPath[1];
						//$path = $tempPath;
        ...
        public function download() {
                ...
                $current_path = $this->getFullPath();
				$realRoot = $_SESSION['siteRoot'];
				$tempPath = explode("http:/",$current_path);
				$current_path = 'http://'.end($tempPath);
