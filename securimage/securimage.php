...
class Securimage {
    ...
    */
    ...
    function Securimage()
    {
        ...
        $this->code_length   = 6;
        $this->charset       = 'ABCDEFGHKMNPRSTUVWYZabcdefghkmnprstuvwyz23456789';
        ...
        $this->ttf_file      = $this->basepath . '/BebasNeue-webfont.ttf';
        ...
        $this->signature_font  = $this->basepath . '/BebasNeue-webfont.ttf';
